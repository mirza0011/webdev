...
def generate_overview(text, bank_name):
    ...
    system_prompt = f"""
    You will be given text that describes the CD (Certificate of Deposit) offerings of {bank_name}. Please provide a one-paragraph overview of these offerings as well as the products' pros and cons. Separate the company overview, the pros, and the cons with tilde (~) characters.  Separate individual pros and cons with pipe characters.
    The information for {bank_name} is directly below and you will find three example outputs in the first three user prompts:\n\n{text}"""

    messages = [
        {"role": "system", "content": system_prompt},
        {"role": "user", "content": "Landmark Credit Union offers a Certificate of Deposit (CD) program that gives account holders a way to invest their savings and see them grow steadily over time. With terms ranging from 3 months to 5 years, there's flexibility to suit varying financial goals and time frames. The minimum investment amount is just $500, and all CDs from Landmark are federally insured by the NCUA for up to $250,000 per account owner, ensuring that your funds are safe and protected. The dividend rates range from 0.50% APY for a 3-month term to 3.83% APY for terms ranging from 18 months to 5 years. ~ Higher APY than regular savings account | Terms from 3 months to 5 years for flexibility | Federally insured up to $250,000 by NCUA | Low minimum deposit of $500 | Multiple CD terms yield higher returns ~ Penalty apply for early withdrawals | Requires an upfront deposit of at least $500 | Locked in rate - can't take advantage if rates rise | Funds cannot be added to the CD after the initial deposit"},
        {"role": "user", "content": "Washington State Employees Credit Union (WSECU) offers Share Certificates that allow individuals to earn a higher Annual Percentage Yield (APY) than standard savings accounts.  Their certificates offer APYs as high as 4.60% on a 7-month product, offering the safety of a checking or savings account while avoiding the unpredictability of the stock market.  As with all certificates of deposit (CDs), the value upon maturity is known from Day 1, making it a good fit for those seeking certainty in their future returns and balances. ~ Higher yield than most savings accounts | Certainty of return upon maturity | Variety of term lengths | Deposits insured up to $250,000 by the NCUA ~ Funds are inaccessible until the certificate's maturity date | Penalties apply for early withdrawals | Cannot add funds to existing certificates, but multiple certificates can be opened"},
        {"role": "user", "content": "Connexus Credit Union offers a versatile selection of Certificate of Deposit (CD) options designed to meet diverse financial goals. Their offerings range from regular CDs to money market CD accounts, with varying maturity terms and competitive rates.  To boot, Connexus offers a top-notch online banking experience and even a rewards program. ~  High Yield CD accounts available | Various maturity options (from 12 to 60 months) | Excellent online banking | Rewards programs | Federally insured up to $250,000 by NCUA | No monthly service fees ~ Requires a minimum balance to open a CD account | Early withdrawal penalties | Lower APY for lower balance tiers | Lack of physical branches for face-to-face assistance | Rewards program not available for all CDs"}
    ]
